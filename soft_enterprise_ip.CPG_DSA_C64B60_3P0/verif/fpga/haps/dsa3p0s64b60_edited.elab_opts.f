...
#MG-file $WORKAREA/output/dsa3p0s64b60/cpp/model/dsa_model/cpp_opts.f
-congruency -cong_hier $WORKAREA/tools/congruency/dsa.icxl2.congruency
-xprop=$WORKAREA/tools/vcs/dsa3p0s64b60_xprop.cfg
-power=rtlpg -power=ignore_latch_split -power=attributes_on
#MG-upf $WORKAREA/output/dsa3p0s64b60/container.upf
+warn=noSVA-TIDE
-error=REO
-error=UNIQUE
-error=TEIF
...
#-full64
-kdb dsa3p0s64b60_uhfi_ref_design_rtl_lib.uhfi_ref_top 
#-syn_dw+dump_dir=$WORKAREA/output/$DUT/fpga/haps_haps/trial/dsaiaa_fpga_1/HAPS-80/analyzed_libs
